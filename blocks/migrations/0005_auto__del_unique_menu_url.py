...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Menu', fields ['url']
        db.delete_unique(u'blocks_menu', ['url'])


    def backwards(self, orm):
        # Adding unique constraint on 'Menu', fields ['url']
        db.create_unique(u'blocks_menu', ['url'])
